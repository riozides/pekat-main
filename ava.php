...
<head>
    ...
    <link rel="stylesheet" href="distlp/css/style.css">
            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Pengaduan Masyarakat</h1>
                        <p class="hero-paragraph is-revealing">Anda harus login terlebih dahulu untuk melakukan pengaduan.
                         Gunakan aplikasi dengan bijak dan cerdas</p>
                        <div class="hero-form newsletter-form field field-grouped is-revealing" style="align-items: center; display: grid; place-items: center;">
                            <!-- <div class="control control-expanded">
                                <input class="input" type="hidden" name="email" placeholder="Your best email&hellip;">
                            </div> -->
                            <div class="control">
                                <a class="button button-success button-block button-shadow" href="log.php">Lapor Yuk!</a>
                            </div>
                        </div>
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; <?= date('Y'); ?> PEKAT, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
<script src="distlp/js/main.min.js"></script>
</body>
</html>